...
//получить узел, следующий перед ориентиром(data-атрибутом)


//console.log(document.querySelector('[data-current="3"]').previousElementSibling);
//получить уже элемент!!!!!, а не узел(parentElement, nextElementSibling и т.д.)
//только нет аналога для .childNodes, но его можно написать вручную
//при помощи for...of

for (let node of document.body.childNodes) { //forEach в данном случае не используем, т.к. в нем нельзя использовать оператор continue
...
//в консоль выведутся только дочерние элементы body т.к. 
//оператор continue прерывает выполнение цикла и осуществляется
//переход к проверке другого элемента